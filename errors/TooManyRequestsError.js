...
var TooManyRequestsError = function (_HttpError) {
  _inherits(TooManyRequestsError, _HttpError);

  function TooManyRequestsError(message) {
    _classCallCheck(this, TooManyRequestsError);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TooManyRequestsError).call(this, message));
