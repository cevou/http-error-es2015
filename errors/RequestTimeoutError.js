...
var RequestTimeoutError = function (_HttpError) {
  _inherits(RequestTimeoutError, _HttpError);

  function RequestTimeoutError(message) {
    _classCallCheck(this, RequestTimeoutError);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(RequestTimeoutError).call(this, message));
