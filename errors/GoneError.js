...
var GoneError = function (_HttpError) {
  _inherits(GoneError, _HttpError);

  function GoneError(message) {
    _classCallCheck(this, GoneError);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(GoneError).call(this, message));
