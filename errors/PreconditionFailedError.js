...
var PreconditionFailedError = function (_HttpError) {
  ...
  function PreconditionFailedError(message) {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PreconditionFailedError).call(this, message));
