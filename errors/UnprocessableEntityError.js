...
var UnprocessableEntityError = function (_HttpError) {
  _inherits(UnprocessableEntityError, _HttpError);

  function UnprocessableEntityError(message) {
    _classCallCheck(this, UnprocessableEntityError);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(UnprocessableEntityError).call(this, message));
