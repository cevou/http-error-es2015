...
var MethodNotAllowedError = function (_HttpError) {
  _inherits(MethodNotAllowedError, _HttpError);

  function MethodNotAllowedError(message) {
    _classCallCheck(this, MethodNotAllowedError);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(MethodNotAllowedError).call(this, message));
