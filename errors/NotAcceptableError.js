...
var NotAcceptableError = function (_HttpError) {
  _inherits(NotAcceptableError, _HttpError);

  function NotAcceptableError(message) {
    _classCallCheck(this, NotAcceptableError);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(NotAcceptableError).call(this, message));
