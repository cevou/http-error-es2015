...
var PaymentRequiredError = function (_HttpError) {
  _inherits(PaymentRequiredError, _HttpError);

  function PaymentRequiredError(message) {
    _classCallCheck(this, PaymentRequiredError);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PaymentRequiredError).call(this, message));
